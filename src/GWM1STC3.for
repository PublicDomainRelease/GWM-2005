...
C     VERSION: 21OCT2008
      ...
      PUBLIC::GWM1STC3AR,GWM1STC3OS,GWM1STC3OS2,GWM1STC3FP,GWM1STC3FPR,
     &        GWM1STC3FM,GWM1STC3OT
C
...
C-----LOCAL VARIABLES
      ...
      INTEGER(I4B)::LOCAT,ISTART,ISTOP,IPRN,IPRNG,NSP,NSEG,NRCH
      REAL(SP)::TBND
...
C---------READ TOTAL NUMBER OF STREAM-CONSTRAINT TYPES
          ...
          IF(TNSF(G).LT.0)CALL USTOP('PROGRAM STOPPED: NSF IS NEGATIVE')
          IF(TNSD(G).LT.0)CALL USTOP('PROGRAM STOPPED: NSD IS NEGATIVE')
...
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
C
      IF(NDEP.EQ.0)THEN                          ! CALL NOT FROM GWMPLL
C
      DO 100 I= 1,NSF+NSD 

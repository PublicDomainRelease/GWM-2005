...
C     VERSION: 11AUG2008
     ...
     &        SMALLEPS,BIGINF
      PUBLIC:: GWM1BAS2PS, GWM1BAS2PF, GWM1BAS2CS,CUTCOM
C
...
C-----DEFINE NUMERIC CONSTANTS AND UNIT NAMES
      ...
      INTEGER(I4B),SAVE::GWMOUT,MPSFILE,RMFILE,RMFILEF,GWMWFILE
C
...
C
      CONTAINS
C***********************************************************************
      SUBROUTINE GWM1BAS2PS(LINE,INDEX)
C***********************************************************************
C     VERSION: 20FEB2005
...
C-----FILE-WRITING ERROR
 ...
 9900 FORMAT(/,1X,'*** ERROR WRITING FILE "',A,'" ON UNIT ',I5,/,
     ...
     &2X,'-- STOP EXECUTION (GWM1BAS2PS)')
      CALL USTOP(' ')
C
      END SUBROUTINE GWM1BAS2PS
C
C
C***********************************************************************
      SUBROUTINE GWM1BAS2PF(LINE,INDEX,VALUE)
C***********************************************************************
C     VERSION: 20FEB2005
...
C-----FILE-WRITING ERROR
 ...
 9900 FORMAT(/,1X,'*** ERROR WRITING FILE "',A,'" ON UNIT ',I5,/,
     ...
     &7X,'SPECIFIED FILE ACCESS: ',A,/
     &7X,'SPECIFIED FILE ACTION: ',A,/
     &2X,'-- STOP EXECUTION (GWM1BAS2PF)')
      CALL USTOP(' ')
C
      END SUBROUTINE GWM1BAS2PF
C
C
C***********************************************************************
      SUBROUTINE GWM1BAS2CS(CTYPE,CNAME,CARHS,CDIR,TFLG)
C***********************************************************************
...
C-----FILE-WRITING ERROR
 ...
 9900 FORMAT(/,1X,'*** ERROR WRITING FILE "',A,'" ON UNIT ',I5,/,
     ...
     &7X,'SPECIFIED FILE ACCESS: ',A,/
     &7X,'SPECIFIED FILE ACTION: ',A,/
     &2X,'-- STOP EXECUTION (GWM1BAS2CS)')
      CALL USTOP(' ')
C
      END SUBROUTINE GWM1BAS2CS
C

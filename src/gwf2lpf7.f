      MODULE GWFLPFMODULE
        ...
        INTEGER, SAVE,   POINTER ::ISFAC,ICONCV,ITHFLG,NOCVCO
      ...
      TYPE GWFLPFTYPE
        ...
        INTEGER, POINTER ::ISFAC,ICONCV,ITHFLG,NOCVCO
        REAL, POINTER    ::WETFCT
...
C     ------------------------------------------------------------------
     ...
     1                      ISFAC,ICONCV,ITHFLG,NOCVCO,WETFCT,
...
C1------Allocate scalar data.
      ...
      ALLOCATE(ISFAC,ICONCV,ITHFLG,NOCVCO)
      ALLOCATE(WETFCT)
      ZERO=0.
C
C2------IDENTIFY PACKAGE

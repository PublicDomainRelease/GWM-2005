README.TXT
                 ...
                 GWM-2005 - Version: 1.2.02 7/27/2010
...
It is recommended that no user files are kept in the GWM2005.1_2_2 
directory structure.  If you do plan to put files in this directory, 
do so only by creating subdirectories.

Included in directory GWM2005.1_2_2\doc are Portable Document Format 
...
directory, the directory containing the executable (GWM2005.1_2_2\bin)
should be included in the PATH environment variable. 

As an alternative, the executable file, gwm2005.exe, in the
GWM2005.1_2_2\bin directory can be copied into a directory already
...
enter
   ...
   %PATH%;C:\GWMpathname\GWM2005.1_2_2\bin
...
add ";C:\GWMpathname\GWM2005.1_2_2\bin" to its definition in the Value 
...
the Edit User Variable window, add ";C:\GWMpathname\GWM2005.1_2_2\bin" 
...
After the executable file in the GWM2005.1_2_2\bin directory is installed 
...
The directory GWM2005.1_2_2\data contains the input data and expected 
...
code is available in the GWM2005.1_2_2\src directory so that the 
...
GWM2005.1_2_2\src directory for removing GMG from MODFLOW.  If the calls to GMG 

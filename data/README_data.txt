...
The directory GWM2005.1_2\test-win can be used to conveniently run the
tests without destroying the original results in the GWM2005.1_2\data
subdirectories. The GWM2005.1_2\test-win directory contains batch (BAT) 
...
directory being GWM2005.1_2\test-win or by double-clicking on the 
corresponding BAT file in Windows Explorer.  The output files that are 
created in GWM2005.1_2\test-win can then be compared to those in the
GWM2005.1_2\data subdirectories. Note that there are three batch files
